...
export default function PatientSidebar({ userName }: { userName: string }) {
  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      badge: { text: "AI", color: "#fff", bg: "#2563EB" },
    },
    {
      label: "Diagnostics",
    ...
    <aside className="fixed top-0 left-0 w-[260px] h-screen bg-white border-r border-[#E2E8F0] flex flex-col z-50">
      ...
      <nav className="flex-1 px-2.5 py-3.5 flex flex-col gap-0.5 overflow-y-auto">
        ...
        <Link
          ...
          style={{ background: pathname.startsWith("/dashboard/patient/profile") ? "#EFF6FF" : "transparent" }}
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
            stroke={pathname.startsWith("/dashboard/patient/profile") ? "#2563EB" : "#94A3B8"}
            strokeWidth="1.8">
          ...
          <span
            className="text-[14px]"
            style={{
              fontFamily: pathname.startsWith("/dashboard/patient/profile") ? "'Plus Jakarta Sans', sans-serif" : "'DM Sans', sans-serif",
              fontWeight: pathname.startsWith("/dashboard/patient/profile") ? 600 : 500,
              color: pathname.startsWith("/dashboard/patient/profile") ? "#2563EB" : "#64748B",
            }}
          >
            Profile
          </span>
